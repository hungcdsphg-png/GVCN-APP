...
- **Quizz Nghiêng Đầu**, **Ngón Tay Thần Kỳ** và **Quét Thẻ QR** tự mở toàn màn hình khi bắt đầu chơi.
- Nút góc màn hình đổi giữa **Toàn màn hình** và **Thu màn hình**. Nhấn nút Thu màn hình hoặc `Esc` chỉ thu giao diện về trong Góc Trò Chơi, không dừng phiên; giao diện vẫn có thể cuộn để sử dụng đầy đủ chức năng.
- Với **Quét Thẻ QR**, bấm **Bắt đầu** sẽ mở mã/hướng dẫn kết nối điện thoại. Nút **HỦY** hủy phiên ghép điện thoại và trở về cấu hình nhưng không xóa bộ câu hỏi.
- Bấm **IN THẺ** sẽ chuẩn bị toàn bộ thẻ học sinh và mở trực tiếp hộp thoại in. Mỗi học sinh vẫn dùng một thẻ QR cố định có 4 hướng A/B/C/D.
